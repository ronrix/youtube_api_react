...
function App() {
    ...
    const getSomeVideos = async () => {
        const {data} = await Youtube.get("/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&regionCode=US&key=AIzaSyBvgJG2rPRmD-t5rNHmhNtOc_EscUcgNhw");
